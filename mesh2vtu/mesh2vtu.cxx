...
//#include <vtkUnstructuredGridToPolyDataFilter.h> replaced with vtkPolyDataAlgorithm
...
int main(int argc, char** argv) {
  ...
  //writer -> SetInput(dataSet); // SetInput() was replaced with SetInputData() from v5
